...
abline(h = 0.8, col = 3)
```
This is much better than before, the red line is close to the green so its ok, slight curve though, but reveals that three was a lot of dispersion before.  
